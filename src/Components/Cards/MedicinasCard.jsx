			...
			<div className="relative bg-white px-4 py-10 sm:rounded-3xl sm:px-10">
				...
				<ul className="mt-10 space-y-8 border-t border-slate-900/10 pt-10 text-sm leading-6 text-slate-700">
					<li className="flex items-center">
						...
						<p className="ml-5">
							<strong className="font-semibold text-slate-900">Por solo $17,00:</strong> Caja de
							Miscelaneas 6.60 Lbs
						</p>
					</li>
					<li className="flex items-center">
						<ArchiveBoxIcon className="w-8 h-8 text-[#0EA5E9]" />
						<p className="ml-5">
							<strong className="font-semibold text-slate-900">Por solo $27,00:</strong> Caja de
					...
					<li className="flex items-center">
						<ArchiveBoxIcon className="w-8 h-8 text-[#0EA5E9]" />
						<p className="ml-5">
							<strong className="font-semibold text-slate-900">Por solo $52,00:</strong> Caja de
