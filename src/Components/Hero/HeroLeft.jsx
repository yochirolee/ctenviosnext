		...
		<BlurFade delay={0.25 * 0.05} inView>
			<div className=" mx-auto  px-4 text-center  ">
				...
				<p className="mt-6 text-lg leading-8 text-gray-600">
					Somos una Empresa de logística internacional, especializada en envíos de cargas marítimas
					y aéreas a toda Cuba, con mas de 20 años de experiencia en el sector
				</p>
