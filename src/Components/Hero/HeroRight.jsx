		...
		<div className="relative mx-auto  px-4 sm:px-6 lg:px-8">
			...
			<div className="mx-auto max-w-2xl sm:py-10 lg:py-42 lg:max-w-none ">
				<div className="justify-center items-center grid grid-cols-2 lg:grid-cols-3  lg:gap-x-6 lg:space-y-0">
					<div className="relative hidden lg:block lg:max-h-80   lg:w-44  -rotate-12  overflow-hidden  rounded-lg bg-white sm:aspect-h-1 sm:aspect-w-2 lg:aspect-h-1 lg:aspect-w-1 group-hover:opacity-75 sm:h-64">
						<Image
							src="/slider4.jpg"
